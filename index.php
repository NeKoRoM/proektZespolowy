...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    <a href="#" onclick="w3_open()" class="w3-hide-large w3-right w3-jumbo w3-padding w3-hover-grey" title="open menu">
  ...
  <div class="w3-bar-block">
    <a href="#Wiadomosci" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>ZALOGUJ!</a>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="Wiadomosci">
    ...
    <div class="w3-container">
    <h1 style="text-align: center;font-size: 50px;color: #d6a738;background-color: #ffdd99;  "><b>Portal ODR</b></h1>
     <h1 style="text-align: center;font-size: 30px;color: #black;  "><b>Zaloguj się i dowiedz się wszystkiego, czego potrzebujesz w swojej dziedzinie</b></h1>
 ...
 <div class="w3-container w3-padding-large w3-grey">
    ...
    <div class="w3-row-padding w3-center w3-padding-24" style="margin:0 -16px">
      ...
      <button class="w3-third w3-dark-grey" onclick="window.location.href = 'login.php';"  >
      ...
      <button class="w3-third w3-dark-grey" onclick="window.location.href = 'admin.php';"  >
...
<div class="w3-third w3-container w3-margin-bottom">  <div class="w3-container w3-white"> <p><b style="font-size:40px">Oleg</b></p><p style="font-size:30px">Nasza firma istnieje od 10 lat, podejmujemy się
                ...
                pracowników to skarb i wszyscy jesteśmy jak wielka przyjazna rodzina</p></div>
    </div>
    <div class="w3-third w3-container w3-margin-bottom">  <div class="w3-container w3-white"> <p><b style="font-size:40px">Roman</b></p><p style="font-size:30px">
